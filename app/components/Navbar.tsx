          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative px-10 py-2.5 min-w-[130px] text-[10px] font-black tracking-widest transition-colors duration-300 z-10 font-kanit ${
                  isActive ? 'text-[#3A4A43]' : 'text-gray-300 hover:text-gray-500'
                }`}
              >
              ...
              {showAccount && (
                ...
                >
                  ...
                  <div className="p-4 mb-2 border-b border-gray-50">
                    {user ? (
                      <>
                        <p className="text-[11px] font-black text-[#3A4A43] uppercase tracking-tight">{user.name}</p>
